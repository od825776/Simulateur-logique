...
// AZZAZ.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CAZZAZApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CAZZAZApp
...
// Le seul et unique objet CAZZAZApp

CAZZAZApp theApp;


// Initialisation de CAZZAZApp

BOOL CAZZAZApp::InitInstance()
{
